...
>
  <div className="lottie-background absolute top-0 left-0 w-[100%] h-[100%] z-[-1]">
  ...
  transition={{ duration:0.8, ease: "easeOut" }}
        className="mb-5 lg:text-6xl md:text-4xl text-3xl font-bold"><span className='text-yellow-600 font-extrabold'>Eid Celebration </span>  Offer – Flat <br /><span >10% OFF!</span></motion.h1>
      <p className="mb-5">
      ...
      <Link to='/all-packages' className="btn btn-accent rounded-full"><motion.button whileHover={{ scale: 1.2 }}
           initial={{ scale: 0 }} animate={{ scale: 1 }}>Explore more </motion.button></Link>
      </div>
    </div>
  </div>
</div>
