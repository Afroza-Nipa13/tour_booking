...
const Banner = () => {
  ...
  <div className="hero-content p-5 relative text-success  rounded-3xl text-shadow-2xs text-center">
    <div className="content py-5">
      <div className='bg-white bg-overlay opacity-80 px-10 py-8 rounder-sm'>
      ...
      <Link to='/all-packages' className="btn btn-wide absolute lg:right-80 lg:top-85 md:right-80 md:top-87 right-30 top-135  object-fit bg-yellow-400 text-yellow-900 font-bold border-none lg:text-xl lg:px-12 lg:py-6">Explore more</Link>
    </div>
  </div>
</div>
